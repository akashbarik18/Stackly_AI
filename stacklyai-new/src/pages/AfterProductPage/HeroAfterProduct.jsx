...
const [showOptions, setShowOptions] = useState(false);
 ...
 const RoomCard = ({ roomName, originalImage, transformedImage }) => {
  ...
  // Handle clicks outside the options to close them
  useEffect(() => {
    const handleClickOutside = (event) => {
  ...
  {/* Top row: Room name + fullscreen icon */}
 <div className="flex justify-between items-center max-w-[520px] min-h-[35px]">
  ...
  <div className="flex items-center gap-3">
    ...
    >
      ...
      {/* Original three icons - hidden by default, shown when showOptions is true */}
      {showOptions ? (
        ...
        // 3-dot button - shown when options are hidden
  ...
  return (
  <section
  className="relative w-full h-auto bg-black opacity-100 -mt-[82px] pt-[82px] overflow-hidden"
...
<div className="w-[1214px] mx-auto p-5 sm:p-10 flex flex-col gap-10 mt-52">
  ...
  <div>
   ...
   <div className="w-[1214px] h-[27px] opacity-100 rotate-0 text-white text-[18px] font-poppins font-normal leading-[100%] text-left mb-8">
  April 2025
</div>


    <div className="grid grid-cols-2 gap-10">
      <RoomCard roomName="Apr 28" originalImage={dragImg1_1} transformedImage={dragImg1_2} />
      <RoomCard roomName="Apr 28" originalImage={dragImg2_1} transformedImage={dragImg2_2} />
    </div>
  </div>

  {/* Bottom Row - Yesterday */}
  <div>
    <div className="w-full h-[27px] text-[#E0E0E0EE] text-[18px] font-poppins font-normal leading-[100%] text-center mb-12">
      Yesterday
    </div>
    <div className="grid grid-cols-2 gap-10">
      <RoomCard roomName="Apr 28" originalImage={dragImg3_1} transformedImage={dragImg3_2} />
      <RoomCard roomName="Apr 28" originalImage={dragImg1_1} transformedImage={dragImg1_2} />
    </div>
  </div>
</div>
