...
import BG1 from "../../assets/afterHome/API After Login.png";
import BG2 from "../../assets/afterHome/API After Login2.png";
import Group from "../../assets/afterHome/Group Api.png";
import card from "../../assets/afterHome/Api Card.png";
import Group2 from "../../assets/afterHome/Group 2.png";
...
export default function AfterHeroApi() {
  ...
  return (
    <div>
      {/* section1 */}
 <div
  className="relative w-full h-[484px] flex flex-col items-center justify-center bg-white-to-cyan bg-cover bg-center -mt-[82px] pt-[82px] overflow-hidden"
...
<div className="w-[705px] h-[135px] opacity-100 flex items-center">
  ...
  <div className="flex items-center justify-center w-[350px] h-[200px]">
    ...
    />
      ...
      <div
        className="relative w-full h-[484px] flex items-center justify-center bg-[#011213] bg-cover bg-center"
